...
```sh
git clone git@github.com:sbrenn-clemson/chisel-rle-encoder.git
cd chisel-rle-encoder
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-rle-encoder'
